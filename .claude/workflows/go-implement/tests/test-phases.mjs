...
//
// Extracts cost functions (lines 66-79), logFeedback (lines 81-95),
// then simulates Phase 1 (lines 425-447) and Phase 2 (lines 503-533)
// gate logic with 8 test cases.

// ---------------------------------------------------------------------------
// Extracted logFeedback (lines 81-95)
// ---------------------------------------------------------------------------
const logs = []
...
// ---------------------------------------------------------------------------
// Simulate Phase 1 gate logic (lines 425-447)
// ---------------------------------------------------------------------------
// Parameters:
...
function phase1Gate(impl, setupCost, implCost) {
  ...
  // Lines 443-447: gate on empty filesModified
...
// ---------------------------------------------------------------------------
// Simulate Phase 2 gate logic (lines 503-533)
// ---------------------------------------------------------------------------
// Parameters:
...
function phase2Gate(tests, impl, implCost, testsCost, setupCost) {
  ...
  // Lines 519-533: testsPassed check
