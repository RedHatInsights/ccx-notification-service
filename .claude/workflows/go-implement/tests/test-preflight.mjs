...
//   1. Jira fetch (lines 262-283)
//   2. Sandbox canary (lines 303-328)
//   3. Preflight checks (lines 337-371)
//
...
/**
 * Simulates the Jira fetch guard (lines 262-283).
...
/**
 * Simulates the sandbox canary guard (lines 303-328).
...
/**
 * Simulates the preflight checks guard (lines 337-371).
