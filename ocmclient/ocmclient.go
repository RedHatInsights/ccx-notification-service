...
// Package ocmclient contains implementation of OCMClient interface. The main
// purpose of this interface is to retrieve access tokens to be used to call
// ServiceLog REST API.
package ocmclient
...
func NewOCMClientWithTransport(clientID, clientSecret, url, tokenURL string, transport http.RoundTripper) (OCMClient, error) {
