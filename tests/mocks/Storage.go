...
// ReadLastNotifiedRecordForClusterList provides a mock function with given fields: clusterEntries
func (_m *Storage) ReadLastNotifiedRecordForClusterList(clusterEntries []types.ClusterEntry) (types.NotifiedRecordsPerCluster, error) {
	ret := _m.Called(clusterEntries)

	var r0 types.NotifiedRecordsPerCluster
	if rf, ok := ret.Get(0).(func([]types.ClusterEntry) types.NotifiedRecordsPerCluster); ok {
		r0 = rf(clusterEntries)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func([]types.ClusterEntry) error); ok {
		r1 = rf(clusterEntries)
	} else {
		r1 = ret.Error(1)
	}
