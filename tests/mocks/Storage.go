...
func (_m *Storage) CleanupNewReports(maxAge string) (int, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CleanupNewReports")
	}
...
func (_m *Storage) CleanupOldReports(maxAge string) (int, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CleanupOldReports")
	}
...
func (_m *Storage) DeleteRowFromNewReports(orgID types.OrgID, clusterName types.ClusterName, updatedAt types.Timestamp) (int, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for DeleteRowFromNewReports")
	}
...
func (_m *Storage) DeleteRowFromReported(orgID types.OrgID, clusterName types.ClusterName, notifiedAt types.Timestamp) (int, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for DeleteRowFromReported")
	}
...
func (_m *Storage) PrintNewReportsForCleanup(maxAge string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for PrintNewReportsForCleanup")
	}
...
func (_m *Storage) PrintOldReportsForCleanup(maxAge string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for PrintOldReportsForCleanup")
	}
...
// ReadClusterList provides a mock function with no fields
func (_m *Storage) ReadClusterList() ([]types.ClusterEntry, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for ReadClusterList")
	}
...
// ReadClusterRuleToggles provides a mock function with no fields
func (_m *Storage) ReadClusterRuleToggles() (types.ClusterDisabledRules, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for ReadClusterRuleToggles")
	}

	var r0 types.ClusterDisabledRules
	var r1 error
	if rf, ok := ret.Get(0).(func() (types.ClusterDisabledRules, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() types.ClusterDisabledRules); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.ClusterDisabledRules)
		}
	}
...
// ReadErrorExists provides a mock function with given fields: orgID, clusterName, updatedAt
func (_m *Storage) ReadErrorExists(orgID types.OrgID, clusterName types.ClusterName, updatedAt types.Timestamp) (bool, error) {
	ret := _m.Called(orgID, clusterName, updatedAt)

	if len(ret) == 0 {
		panic("no return value specified for ReadErrorExists")
	}

	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(types.OrgID, types.ClusterName, types.Timestamp) (bool, error)); ok {
		return rf(orgID, clusterName, updatedAt)
	}
	if rf, ok := ret.Get(0).(func(types.OrgID, types.ClusterName, types.Timestamp) bool); ok {
		r0 = rf(orgID, clusterName, updatedAt)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
func (_m *Storage) ReadLastNotifiedRecordForClusterList(clusterEntries []types.ClusterEntry, timeOffset string, eventTarget types.EventTarget) (types.NotifiedRecordsPerCluster, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ReadLastNotifiedRecordForClusterList")
	}
...
// ReadNotificationTypes provides a mock function with no fields
func (_m *Storage) ReadNotificationTypes() ([]types.NotificationType, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for ReadNotificationTypes")
	}
...
func (_m *Storage) ReadReportForCluster(orgID types.OrgID, clusterName types.ClusterName) (types.ClusterReport, types.Timestamp, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ReadReportForCluster")
	}
...
func (_m *Storage) ReadReportForClusterAtOffset(orgID types.OrgID, clusterName types.ClusterName, offset types.KafkaOffset) (types.ClusterReport, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ReadReportForClusterAtOffset")
	}
...
func (_m *Storage) ReadReportForClusterAtTime(orgID types.OrgID, clusterName types.ClusterName, updatedAt types.Timestamp) (types.ClusterReport, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ReadReportForClusterAtTime")
	}
...
// ReadStates provides a mock function with no fields
func (_m *Storage) ReadStates() ([]types.State, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for ReadStates")
	}
...
func (_m *Storage) WriteNotificationRecord(notificationRecord *types.NotificationRecord) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for WriteNotificationRecord")
	}
...
func (_m *Storage) WriteNotificationRecordForCluster(clusterEntry types.ClusterEntry, notificationTypeID types.NotificationTypeID, stateID types.StateID, report types.ClusterReport, notifiedAt types.Timestamp, errorLog string, eventTarget types.EventTarget) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for WriteNotificationRecordForCluster")
	}
...
func (_m *Storage) WriteNotificationRecordImpl(orgID types.OrgID, accountNumber types.AccountNumber, clusterName types.ClusterName, notificationTypeID types.NotificationTypeID, stateID types.StateID, report types.ClusterReport, updatedAt types.Timestamp, notifiedAt types.Timestamp, errorLog string, eventType types.EventTarget) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for WriteNotificationRecordImpl")
	}
...
func (_m *Storage) WriteReadError(orgID types.OrgID, clusterName types.ClusterName, lastCheckedTime time.Time, e error) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for WriteReadError")
	}
